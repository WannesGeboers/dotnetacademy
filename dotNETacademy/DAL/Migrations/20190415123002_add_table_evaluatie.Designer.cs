...
namespace dotNETacademy.Migrations
{
    ...
    [Migration("20190415123002_add_table_evaluatie")]
    partial class add_table_evaluatie
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotNETacademy.Models.Objecten.BestandUrl", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("EvaluatieId");

                    b.Property<string>("Pad");

                    b.HasKey("Id");

                    b.HasIndex("EvaluatieId");

                    b.ToTable("BestandUrl");
                });
            ...
            modelBuilder.Entity("dotNETacademy.Models.Objecten.BestandUrl", b =>
                {
                    b.HasOne("dotNETacademy.Models.Evaluatie")
                        .WithMany("BestandURLs")
                        .HasForeignKey("EvaluatieId");
                });
